...
Tu función es identificar actividades, servicios y obligaciones que el contratista debe ejecutar. No te interesan bienes como entradas principales ni documentos como entregables principales, salvo como cruce.

## Tarea

Extrae transporte, instalación, desmontaje, configuración, pruebas, puesta en marcha, capacitación, mantenimiento, soporte, garantía operativa, coordinación, seguridad, embalaje, almacenamiento y obras/actividades constructivas de ejecución.
...
- El texto usa verbo de ejecución: instalar, construir, montar, configurar, probar, capacitar, mantener, transportar, desmontar, adecuar
- Obligación operativa o servicio durante ejecución
- Servicio posterior a aceptación: mantenimiento, soporte, garantía extendida
- Obra civil o resultado físico formulado como actividad constructiva

Excluye si cae en cualquiera de estas reglas:

- Documento entregable sin actividad: eje 2
- Bien/equipo/licencia a suministrar como objeto: eje 4
- Documento de propuesta/firma: eje 1
- Condición comercial general: eje 0
...
- INCLUIR: Se deberá construir una losa de concreto de 2 x 2 m — actividad/obra de ejecución primaria
- EXCLUIR: Se suministrará un switch — bien; eje 4
- INCLUIR: Se suministrará e instalará un switch — eje 3 captura instalación; eje 4 captura switch

## Reglas de fase de este eje

- Usa execution_pre_acceptance para obligaciones hasta entrega/aceptación
- Usa post_acceptance para mantenimiento/soporte/garantía posterior
- No uses proposal para servicios de ejecución
